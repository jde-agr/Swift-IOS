...
class TweetyCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        tweetLabel.rightAnchor.constraint(equalTo: self.rightAnchor).isActive = true
        tweetLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor).isActive = true
